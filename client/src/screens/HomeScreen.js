...
import { Card, Title, Paragraph, Button, Text, Image } from 'react-native-paper';
  ...
  return (
    <ScrollView style={homeScreenStyles.container}>
      ...
      <Card style={homeScreenStyles.topSection}>
        <Card.Cover source={{ uri: 'https://example.com/strong-core.jpg' }} />
        <Card.Content>
      ...
      <ScrollView horizontal>
        <Card style={homeScreenStyles.card}>
          <CustomVideoPlayer source={require('../assets/videos/sample_video1.mp4')} style={homeScreenStyles.video} />
          <Card.Content>
        ...
        <Card style={homeScreenStyles.card}>
          <CustomVideoPlayer source={require('../assets/videos/sample_video2.mp4')} style={homeScreenStyles.video} />
          <Card.Content>
        ...
        <Card style={homeScreenStyles.card}>
          <CustomVideoPlayer source={require('../assets/videos/sample_video3.mp4')} style={homeScreenStyles.video} />
          <Card.Content>
